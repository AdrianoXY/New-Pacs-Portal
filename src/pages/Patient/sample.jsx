    ...
    <div class="grid h-screen w-screen grid-cols-10 grid-rows-9 overflow-auto">
      <div class="col-span-3 col-start-1 row-span-full row-start-1 flex h-full w-full flex-col items-center justify-center ">
        <div class=" flex h-[93%] w-[90%] items-center justify-center rounded-lg bg-white drop-shadow-md">
          <div class="grid h-[95%] w-[90%] grid-cols-2 ">
            <div class="col-span-2 row-span-3 grid grid-cols-3 grid-rows-6">
            ...
            <div class="col-span-2 row-span-3 grid h-[95%] grid-cols-3 grid-rows-7 border-t-2">
            ...
            <div class="col-span-2 row-span-3 grid grid-cols-3 grid-rows-6 border-t-2">
      ...
      <div class="col-span-7 col-start-4 row-span-2">
          ...
          <table class="w-[98%] table-auto bg-white drop-shadow-md rounded-md">
            <caption class='text-left text-2xl'>Sequencing raw data(.fastq)</caption>
            <thead>
              <tr>
        ...
        <div class="col-span-7 col-start-4 row-span-2">
          ...
          <table class="w-[98%] table-auto bg-white drop-shadow-md rounded-md">
          <caption class='text-left text-2xl'>Variant calling (.vcf, .tbi, .idx)</caption>
          <thead>
              <tr>
                <th class="border-b-2">No.</th>
                <th class="border-b-2">File Name</th>
        ...
        <div class="col-span-7 col-start-4 row-span-2">
          ...
          <table class="w-[98%] table-auto bg-white drop-shadow-md rounded-md">
          <caption class='text-left text-2xl'>Annotation (.csvv, .xlsx)</caption>
          <thead>
              <tr>
                <th class="border-b-2">No.</th>
                <th class="border-b-2">File Name</th>

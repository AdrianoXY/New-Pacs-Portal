...
const Home = () => {
  ...
  return (
    <div class="grid h-[997px] w-screen grid-cols-8 grid-rows-6 overflow-auto">
      ...
      <div class="col-span-8 row-span-3 flex flex-col items-center">
        <div class="flex h-5/6 w-full flex-col items-center">
          <table class="mt-5 w-4/5 table-auto">
            <caption class='text-left text-white text-5xl mb-4'>Variation Point</caption>
            <thead>
              <tr class="h-[50px]">
                <th class="rounded-tl-lg bg-emerald-800 text-white">No.</th>
                <th class="border-l-2 bg-emerald-800 text-white">File Name</th>
                <th class="border-l-2 bg-emerald-800 text-white">Status</th>
                <th class="border-x-2 bg-emerald-800 text-white">Process Rate</th>
                <th class="rounded-tr-lg bg-emerald-800 text-white">Operation</th>
              </tr>
            </thead>
            <tbody>
              <tr class="h-[50px]">
